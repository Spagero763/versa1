    ...
    <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="relative flex flex-col items-center">
        ...
        <p className="mt-4 max-w-xl text-center text-lg text-muted-foreground">
          The ultimate game of strategy. Challenge our powerful AI and prove your skills.
        </p>
        <Card className="w-full max-w-2xl mt-8 shadow-2xl shadow-primary/10 border-primary/20 border">
